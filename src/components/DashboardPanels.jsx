...
const INITIAL_LAYOUTS = {
  ...
  xs: [
    { i: 'map', x: 0, y: 0, w: 1, h: 22 },
    { i: 'weather', x: 0, y: 76, w: 1, h: 8 },
    { i: 'aqi', x: 0, y: 22, w: 1, h: 6 },
    { i: 'news', x: 0, y: 126, w: 1, h: 8 },
    { i: 'stream1', x: 0, y: 48, w: 1, h: 8 },
    { i: 'stream2', x: 0, y: 56, w: 1, h: 8 },
    { i: 'stream3', x: 0, y: 34, w: 1, h: 8 },
    { i: 'markets', x: 0, y: 28, w: 1, h: 6 },
    { i: 'currency', x: 0, y: 42, w: 1, h: 6 },
    { i: 'sectors', x: 0, y: 199, w: 1, h: 9 },
    { i: 'rbi', x: 0, y: 169, w: 1, h: 6 },
    { i: 'intel', x: 0, y: 84, w: 1, h: 5 },
    { i: 'macro', x: 0, y: 64, w: 1, h: 6 },
    { i: 'politics', x: 0, y: 104, w: 1, h: 8 },
    { i: 'security', x: 0, y: 150, w: 1, h: 6 },
    { i: 'infra', x: 0, y: 70, w: 1, h: 6 },
    { i: 'trade', x: 0, y: 143, w: 1, h: 7 },
    { i: 'reservoir', x: 0, y: 175, w: 1, h: 8 },
    { i: 'energy', x: 0, y: 163, w: 1, h: 6 },
    { i: 'renewables', x: 0, y: 156, w: 1, h: 7 },
    { i: 'tech', x: 0, y: 99, w: 1, h: 5 },
    { i: 'unicorn', x: 0, y: 89, w: 1, h: 10 },
    { i: 'movies', x: 0, y: 112, w: 1, h: 7 },
    { i: 'borders', x: 0, y: 183, w: 1, h: 9 },
    { i: 'cyber', x: 0, y: 208, w: 1, h: 9 },
    { i: 'disasters', x: 0, y: 134, w: 1, h: 9 },
    { i: 'mandi', x: 0, y: 119, w: 1, h: 7 },
    { i: 'elections', x: 0, y: 192, w: 1, h: 7 },
    { i: 'system', x: 0, y: 217, w: 1, h: 16 },
  ],
  xxs: [
    { i: 'map', x: 0, y: 0, w: 1, h: 22 },
    { i: 'weather', x: 0, y: 76, w: 1, h: 8 },
